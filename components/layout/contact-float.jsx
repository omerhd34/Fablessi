...
import { ArrowUp as TbArrowUp, Phone as TbPhone } from "lucide-react";
...
export function ContactFloat() {
 ...
 return (
  <div className="pointer-events-none fixed inset-x-auto right-5 bottom-(--contact-float-bottom) z-50">
