...
export function getSiteWorkingHours(locale = defaultLocale) {
 const dictionary = getDictionary(locale);

 return [
  { label: dictionary.contact.weekdays, hours: SITE_HOURS_RANGE },
  { label: dictionary.contact.weekend, hours: SITE_HOURS_RANGE },
 ];
}
