...
export const IMAGE_UPLOAD_MAX_SIZE_MB = 30;
export const IMAGE_UPLOAD_MAX_SIZE_BYTES = IMAGE_UPLOAD_MAX_SIZE_MB * 1024 * 1024;
export const IMAGE_UPLOAD_MAX_SIZE_LABEL = `${IMAGE_UPLOAD_MAX_SIZE_MB} MB`;
...
export function validateImageUploadFile(file) {
 ...
 if (file.size > IMAGE_UPLOAD_MAX_SIZE_BYTES) {
  return `Dosya ${IMAGE_UPLOAD_MAX_SIZE_LABEL}'dan büyük olamaz.`;
 }
