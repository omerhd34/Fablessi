 ...
 * Metinler SEO tablosuyla birebir.
 */
function seoEntry(pageTitle, description, metaTitle = null) {
 return {
  pageTitle,
  metaTitle: metaTitle ?? `${pageTitle} - ${brandName}`,
  description,
 };
}
...
export const trPageSeo = {
 home: seoEntry(
  brandName,
  trLocalSeoDescription,
  `${brandName} - İnegöl Bahçe & Balkon Mobilyaları`
 ),
 about: seoEntry(
  "Hakkımızda",
...
export const enPageSeo = {
 home: seoEntry(
  brandName,
  enLocalSeoDescription,
  `${brandName} - İnegöl Garden and Balcony Furniture`
 ),
 about: seoEntry(
  "About Us",
