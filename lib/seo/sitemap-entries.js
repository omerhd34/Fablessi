...
const STATIC_PAGES = [
 ...
 { path: "/degerlerimiz", priority: 0.7, changeFrequency: "monthly" },
 { path: "/taahhutlerimiz", priority: 0.7, changeFrequency: "monthly" },
 { path: "/sss", priority: 0.7, changeFrequency: "monthly" },
 { path: "/politikalar", priority: 0.5, changeFrequency: "yearly" },
];
