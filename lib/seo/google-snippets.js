...
export const trGoogleSitelinks = [
 ...
 },
 {
  ...
  description:
   "Bahçe, balkon ve teras için şık masa takımları. İnegöl üretimi dayanıklı dış mekan yemek masaları ve sandalye setleri.",
 },
 {
  key: "salincak",
  name: "Salıncaklar",
...
export function getGoogleCatalogMetadata({
 categorySlug,
 locale = "tr",
 dictionary,
 categoryLabel = null,
 ...
 if (categorySlug) {
  const title =
   sitelink?.name ??
   categoryLabel ??
   dictionary.categories?.[categorySlug] ??
   page.title;
