...
function buildSitelinksFromCatalog(catalogSeo, pageSeo, locale) {
 return [
  {
   key: "products",
   name: catalogSeo.default.pageTitle,
   href: "/urunler",
  ...
  {
   key: "about",
   name: pageSeo.about.pageTitle,
   href: "/hakkimizda",
   description: pageSeo.about.description,
  },
  {
   key: "faq",
   name: pageSeo.faq.pageTitle,
   href: "/sss",
   description: pageSeo.faq.description,
  },
  {
   key: "missionVision",
   name: pageSeo.missionVision.pageTitle,
   href: "/misyon-vizyon",
   description: pageSeo.missionVision.description,
  },
  {
   key: "contact",
