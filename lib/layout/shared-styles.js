export const containerPremiumClass =
 "mx-auto w-full max-w-site px-4 sm:px-5 md:px-6 lg:px-8 xl:px-10";

export const containerShellClass =
 "mx-auto w-full max-w-site-shell px-4 sm:px-5 md:px-6 lg:px-10 xl:px-12";
...
export const pageContentOffsetClass =
 "relative z-0 -mt-[calc(var(--header-height-mobile)+var(--search-bar-height))] pt-[calc(2*(var(--header-height-mobile)+var(--search-bar-height))+1.5rem)] sm:max-lg:-mt-[calc(var(--header-height-mobile-sm)+var(--search-bar-height))] sm:max-lg:pt-[calc(2*(var(--header-height-mobile-sm)+var(--search-bar-height))+1.5rem)] lg:-mt-[calc(var(--header-height-desktop)+var(--search-bar-height))] lg:pt-[calc(2*(var(--header-height-desktop)+var(--search-bar-height))+2rem)]";

export const pageHeaderBleedClass =
 "page-header-bleed -mt-[calc(var(--header-height-mobile)+var(--search-bar-height)+1.5rem)] sm:max-lg:-mt-[calc(var(--header-height-mobile-sm)+var(--search-bar-height)+1.5rem)] lg:-mt-[calc(var(--header-height-desktop)+var(--search-bar-height)+2rem)]";
