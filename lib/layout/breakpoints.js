 ...
 * Tailwind: sm=640, md=768, lg=1024, xl=1440px (tailwind.config.js + @theme --breakpoint-xl)
...
/** xl - 1440px (px kullanın; rem tarayıcı yazı boyutundan etkilenir) */
export const XL_MIN = "1440px";
export const XL_MQ = `(min-width: ${XL_MIN})`;
...
/** Mobil/tablet düzen üst sınırı - 1440px */
