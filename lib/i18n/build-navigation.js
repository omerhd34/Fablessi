...
export function buildNavigation(dictionary, menuGroups = null) {
 ...
 return {
  ...
  footerExploreLinks: [
   ...
   { label: footer.values, href: "/degerlerimiz" },
   { label: footer.commitments, href: "/taahhutlerimiz" },
   { label: footer.faq, href: "/sss" },
   { label: footer.helpPolicies, href: "/politikalar" },
  ],
    ...
    items: [
     ...
     { label: nav.faq, href: "/sss", icon: "faq" },
     {
      ...
      children: [
       ...
       { label: nav.values, href: "/degerlerimiz", icon: "values" },
       { label: nav.commitments, href: "/taahhutlerimiz", icon: "commitments" },
       { label: nav.policies, href: "/politikalar", icon: "policies" },
      ],
     },
